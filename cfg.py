...
# _BASE_DIR = 'F:\\Renyankai\\project\\pytorch\\python\\Deep Learning\\pytorch-YOLOv4-master\\'
...
# Cfg.train_label = 'F:\\Renyankai\\project\\pytorch\\python\\Deep Learning\\pytorch-YOLOv4-master\\data\\coins\\train.txt'
Cfg.val_label = os.path.join(_BASE_DIR, 'data' ,'val.txt')
# Cfg.val_label = 'python\\Deep Learning\\pytorch-YOLOv4-master\\data\\val.txt'
